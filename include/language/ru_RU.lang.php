...
$app_strings = array(
    ...
    'LBL_ID_FF_ADD' => 'Add Email Address' /*for 508 compliance fix*/,
    ...
    'LBL_ID_FF_REMOVE' => 'Remove Email Address' /*for 508 compliance fix*/,
    'LBL_ID_FF_OPT_OUT' => 'Opt Out', // PR 3528
    'LBL_ID_FF_INVALID' => 'Make Invalid', // PR 3528
...
5. Из меню модуля запустите процесс импорта и выберите только что сохранённый файл в качестве источника данных для загрузки
   ...
   ',
    ...
    'LBL_EMAIL_PRIM_TITLE' => 'Make Primary Email Address', //PR 3528
